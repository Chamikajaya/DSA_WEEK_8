...
struct HashTable{
    ...
    void hash_lookup(string user_name){
        ...
        if (empty){
            // If the slot is empty, the user doesn't exist
            cout<<"User does not exist in the hash table.\n";
        }
        else {
            // If the slot is not empty, search the linked list for the user
